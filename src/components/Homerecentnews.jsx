        ...
        <div className="row">
          <div className="col-xl-4 col-md-6">
            <div className="post-box">
              <div className="post-img">
                <img
                  src="assets/img/news/news-dialysis.jpg"
                  className="img-fluid"
                  alt=""
                />
              </div>
          ...
          <div className="col-xl-4 col-md-6">
            <div className="post-box">
              <div className="post-img">
                <img
                  src="assets/img/news/news-home-care.jpg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              <p>
                For additional informations and booking <br /> CONTACT US 0469
                278 2262, 8281161330
              </p>
            </div>
          </div>
          ...
          <div className="col-xl-4 col-md-6">
            <div className="post-box">
              <div className="post-img">
                <img
                  src="assets/img/news/news-mortuary-service.jpg"
                  className="img-fluid"
                  alt=""
                />
              </div>
